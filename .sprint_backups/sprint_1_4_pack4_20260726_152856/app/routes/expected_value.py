...
def _page_context(db, request: Request, *, assessment=None, strategy_decision=None, error=None, message=None):
...
def calculate_expected_value(
    ...
    try:
        ...
        return templates.TemplateResponse(
            "expected_value.html",
            _page_context(db, request, assessment=assessment, strategy_decision=strategy_decision),
        )
