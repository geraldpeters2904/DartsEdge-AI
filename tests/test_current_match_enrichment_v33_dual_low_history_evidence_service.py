...
from app.services.current_match_enrichment_v33_dual_low_history_evidence_service import (
    CurrentMatchEnrichmentV33DualLowHistoryEvidenceService,
    V33DualLowHistoryCandidateEvidence,
)


class CurrentMatchEnrichmentV33DualLowHistoryEvidenceServiceTests(
    unittest.TestCase
):
    def setUp(self):
        self.service = (
    ...
    def test_ranking_prefers_lower_brier_then_logloss(self):
        better = V33DualLowHistoryCandidateEvidence(
            multiplier=0.5,
            accuracy=60.0,
            brier_score=0.22,
            log_loss=0.64,
        ...
        worse = V33DualLowHistoryCandidateEvidence(
            multiplier=1.0,
            accuracy=65.0,
            brier_score=0.23,
            log_loss=0.62,
