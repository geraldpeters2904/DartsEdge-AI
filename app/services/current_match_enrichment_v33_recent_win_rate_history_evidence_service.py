...
class V33RecentWinRateHistoryCandidateEvidence:
    multiplier: float
...
@dataclass(frozen=True)
class V33RecentWinRateHistoryEvidenceReport:
    model_version: str
    ...
    training_winner: V33RecentWinRateHistoryCandidateEvidence

    validation_baseline: V33RecentWinRateHistoryCandidateEvidence
    validation_candidate: V33RecentWinRateHistoryCandidateEvidence
...
class CurrentMatchEnrichmentV33RecentWinRateHistoryEvidenceService:
    """
    Read-only training/hold-out evidence for history-aware
    recent_win_rate scaling on transparent-v3.3.

    Candidate multipliers are selected on one deterministic
    training window and tested against unchanged v3.3 behaviour
    on an independent hold-out window.
    ...
    def analyse(
        ...
        *,
    ...
    ) -> V33RecentWinRateHistoryEvidenceReport:
        ...
        return V33RecentWinRateHistoryEvidenceReport(
            model_version=(
    ...
    def _evaluate(
        ...
        *,
        ...
        return V33RecentWinRateHistoryCandidateEvidence(
            multiplier=float(
                multiplier
            ),
    ...
    def _recommendation(
        *,
        ...
        if (
            ...
            return (
                True,
                "The history-aware recent_win_rate challenger "
                "improved both hold-out probability metrics "
        ...
        return (
            False,
            "The history-aware recent_win_rate challenger "
            "did not satisfy the hold-out acceptance criteria.",
        )
